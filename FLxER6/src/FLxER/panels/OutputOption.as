package FLxER.panels {
	...
	public class OutputOption extends Palette {
		...
		public function OutputOption(w:uint,h:uint,t:String,fnz:Function,fnzclose:Function):void {
			...
			//
			cntObj.pulsSave 	= new ButtonTxt(5, 105, 50, 15, "SIMPLE FULLSCREEN", simpleFullscreen, null, null);
			cntObj.pulsCancel 	= new ButtonTxt(60, 105, 50, 15, "MANUAL", manualFullscreen, null, null);
			cntObj.pulsReset 	= new ButtonTxt(115, 105, 50, 15, "CLOSE", myCancel, null, null);
